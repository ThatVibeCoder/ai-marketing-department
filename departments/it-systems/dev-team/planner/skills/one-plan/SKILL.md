---
name: one-plan
description: Turn any build request into a one-page plan for the owner's yes. Use before every dev-team job of more than one step.
---

# one-plan

One page, then a yes, then the work.
...
- No jargon survives. "Deploy" becomes "put it on the live internet."
- If the plan needs something that doesn't exist yet (a key, an account, a filled brand file), the plan STARTS with getting it, not a footnote.

## Deliver
The page, then wait for the yes. The yes starts the work; silence doesn't.
